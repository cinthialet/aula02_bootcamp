...
#primeiro_n_inteiro = int(input("Coloque o primeiro numero inteiro = "))
#segundo_n_inteiro = int(input("Coloque o segundo numero inteiro = "))
#resultado = primeiro_n_inteiro // segundo_n_inteiro
#print("O resultado da divisão é:", resultado)

# 5. Escreva um programa que calcule o quadrado de um número fornecido pelo usuário.

#num = int(input("Digite um numero: "))
#res_num_quadrado = num ** 2
#print("O resultado do número ao quadrado é:", res_num_quadrado)
